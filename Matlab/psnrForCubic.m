...
for i=1:n
    ...
    for frame = 1:totalFrame
        ...
        cubicSuperOnRGBfile = strcat(CubicSuperOnDir,rgbFile);
        cubicSuperOffRGBfile = strcat(CubicSuperOffDir,rgbFile);
        
        GTcubicOnRGBfile = strcat(gtCubicOnDir,rgbFile);
        GTcubicOffRGBfile = strcat(gtCubicOffDir,rgbFile);
        GTcubicSuperOnRGBfile = strcat(gtCubicSuperOnDir,rgbFile);
        GTcubicSuperOffRGBfile = strcat(gtCubicSuperOffDir,rgbFile);
        ...
        psnrCubicSuperOn = calculatePSNR(cubicSuperOnRGBfile,GTcubicSuperOnRGBfile,H,W) + psnrCubicSuperOn;
        psnrCubicSuperOff = calculatePSNR(cubicSuperOffRGBfile,GTcubicSuperOffRGBfile,H,W) + psnrCubicSuperOff;

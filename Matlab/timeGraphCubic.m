...
for i =1:n
    ...
    lightOnFig = [resultImgDir 'cubicTimingLightOn.png'];
    lightOffFig = [resultImgDir 'cubicTimingLightOff.png'];
    superOnFig = [resultImgDir 'cubicTimingSuperOn.png'];
    superOffFig = [resultImgDir 'cubicTimingSuperOff.png'];
    timingFig = [resultImgDir 'cubicTiming.png'];
    dirName = [dir num2str(H) 'by' num2str(W) '/' num2str(intPercent) '/Result/triCubic'];
...
title('Timinig Diagram for tri-cubic interpolation with lighting condition');
...
%set(gca,'DefaultTextFontSize',18)
set(gca, 'XTick',[1:n],'XTickLabel', p)
title('Timinig Diagram for tri-cubic interpolation without lighting condition');
xlabel('percentage of using pixels');
ylabel('time in mili-seconds to construct one frame');
legend('Volume Rendering','Reconstruciton','FPS');
...
%set(gca,'DefaultTextFontSize',18)
set(gca, 'XTick',[1:n],'XTickLabel', p)
title('Timinig Diagram for tri-cubic interpolation with Super Sampling and lighting condition');
xlabel('percentage of using pixels');
ylabel('time in mili-seconds to construct one frame');
legend('Volume Rendering','Reconstruciton','FPS');
...
%set(gca,'DefaultTextFontSize',18)
set(gca, 'XTick',[1:n],'XTickLabel', p)
title('Timinig Diagram for tri-cubic interpolation with Super Sampling but lighting condition');
xlabel('percentage of using pixels');
ylabel('time in mili-seconds to construct one frame');
legend('Volume Rendering','Reconstruciton','FPS');

...
for i=1:n
    ...
    for frame = 1:totalFrame
        ...
        gtIsoSuperLinearDir = [path '/' num2str(100) '/Result/isoSurface/superSampling/linear/'];
...
figure;
plot(x,yIsoLinear,'-o',x,yIsoCubic,'-o',x,yIsoSuperLinear, x,yIsoSuperCubic,'-o','LineWidth',2);
grid on
grid minor

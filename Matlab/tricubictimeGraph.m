...
volName = '../resultImages/tricubic/volFigure.png';
reconName = '../resultImages/tricubic/reconFigure.png';
fpsName = '../resultImages/tricubic/fpsFigure.png';
timingName = '../resultImages/tricubic/timingFigure.png';
...
for i =1:n
    ...
    dirName = [num2str(H) 'by' num2str(W) '_' num2str(intPercent) '/Result/tricubic/timing/timer.txt'];

...
float transferScale,bool isoSurface, float isoValue, bool lightingCondition, bool isoLinear, float tstep, bool cubic, bool cubicLight, bool superSampling, int filterMethod, float *d_temp);
